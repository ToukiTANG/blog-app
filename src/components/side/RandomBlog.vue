  ...
  <div class="random-blog">
    <el-card class="random-container" shadow="hover" style="{padding: 0}">
      ...
      <div class="blog-container">
        <div class="blog-item" v-for="blog in randomBlogList" :key="blog.blogId" @click="view(blog.blogId)">
...
export default {
  ...
  data() {
    return {
      default_img: "http://rg54u4oo6.hn-bkt.clouddn.com/random_default.jpg"
      /*randomList: [*/
      /*  {*/
      /*    "id": 1,*/
      /*    "title": "随机文章1",*/
