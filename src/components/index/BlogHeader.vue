<template>
  ...
  <div class="image-header" ref="header">
    <div class="main-image">
      <img class="img-view" src="http://rg54u4oo6.hn-bkt.clouddn.com/Lumine.jpg" alt="main-image">
    </div>
    <div class="wrapper">
      <div>
      ...
      <div class="wave1" style="background: url(http://rg54u4oo6.hn-bkt.clouddn.com/wave1.png) repeat-x"></div>
      <div class="wave2" style="background: url(http://rg54u4oo6.hn-bkt.clouddn.com/wave2.png) repeat-x"></div>
    </div>
  </div>
</template>
